# Modified from MAR's diffusion repo: https://github.com/LTH14/mar and the denoising-diffusion repo: https://github.com/lucidrains/denoising-diffusion-pytorch
import math
import numpy as np
import torch as th
import enum
